  ...
  return (
    <div className="px-6 md:px-9 lg:px-12 py-4 md:py-6 lg:py-8">
      ...
      <div>
        ...
        {viewMode === 'flashcard' && (
          <div className="flex h-[40vh] relative cursor-pointer">
            ...
            {Object.keys(words).map((key, index) => {
              ...
              return (
                <div
                  className={`${divStyle} py-4 px-3 bg-neutral-200 mb-2 rounded w-full h-full flex flex-col justify-center align-middle absolute`}
                  key={word.id}
                >
                  {/* <div> */}
