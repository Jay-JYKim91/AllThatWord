        ...
        <div className="flex items-center justify-between">
          ...
          {data.word in words ? (
            ...
            <div className="relative">
              ...
              <div
                className="bg-white border border-primary-900 hidden absolute right-0 p-4 w-max"
                id="modal"
              >
                <p className="text-center text-lg">Add words</p>
                <button
                  id="displayFormBtn"
                  type="button"
                  className="flex text-neutral-600"
