...
const Admin: React.FC<Props> = ({ words, setWords }) => {
  ...
  const findParentElement = (
    ...
    //   realTarget = target;
    // } else if ((target.parentElement as Element).classList.contains('card')) {
    //   realTarget = target.parentElement;
    // } else if (
    //   (
    //     (target.parentElement as Element).parentElement as Element
    //   ).classList.contains('card')
    // ) {
    //   realTarget = (target.parentElement as Element).parentElement;
    // }
  };
