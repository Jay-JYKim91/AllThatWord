            ...
            <div key={meaning.partOfSpeech}>
              ...
              <div>
                {meaning.synonyms.length !== 0 && (
                  <div>
                    <p className="font-heading_font text-lg">Synonyms</p>
                    <div className="flex flex-wrap text-neutral-600">
                      {meaning.synonyms.map((synonym) => {
                        const url = `/search/${synonym}`;
                        return (
                          <span className="mr-2 bg-neutral-200" key={synonym}>
                ...
                {meaning.antonyms.length !== 0 && (
                  <div>
                    <p className="font-heading_font">Antonyms</p>
                    <div className="flex flex-wrap">
                      {meaning.antonyms.map((antonym) => {
                        const url = `/search/${antonym}`;
                        return (
                          <span className="mr-2" key={antonym}>
