...
const Search: React.FC<Props> = ({ setWords }) => {
    ...
    <div className="px-6 md:px-9 lg:px-12 py-4 md:py-6 lg:py-8">
      ...
      <div className="py-4">
        <div className="flex items-center justify-between">
          ...
          <button type="button" onClick={() => handleAdd(data)}>
            <BsBookmarkPlusFill className="text-2xl text-primary-900" />
          </button>
        </div>
