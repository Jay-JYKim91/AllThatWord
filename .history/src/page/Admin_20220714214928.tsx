        ...
        {viewMode === 'flashcard' && (
          <div className="flex h-[40vh]">
            <button type="button" onClick={() => handlePrevCard()}>
              <AiOutlineCaretLeft className="text-primary-900 text-3xl" />
            </button>
            {Object.keys(words).map((key, index) => {
              ...
              return (
                <div
                  className={`${divStyle} py-4 px-3 bg-neutral-200 mb-2 rounded w-full h-full flex flex-col justify-center align-middle`}
                  key={word.id}
                >
                  {/* <div> */}
            ...
            <button type="button" onClick={() => handleNextCard()}>
              <AiOutlineCaretRight className="text-primary-900 text-3xl" />
            </button>
          </div>
        )}
      </div>
