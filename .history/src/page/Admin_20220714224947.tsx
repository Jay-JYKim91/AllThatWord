        ...
        {viewMode === 'flashcard' && (
          <div className="h-[40vh] overflow-hidden relative">
            <button type="button" onClick={() => handlePrevCard()}>
              <AiOutlineCaretLeft className="text-primary-900 text-3xl mr-2 absolute left-0 inset-y-1/2 cursor-pointer" />
            </button>
                ...
                <div
                  ...
                  onClick={(event) => {
                    ...
                    if (target.classList.contains('card')) {
                      ...
                      (target.parentElement as Element).classList.contains(
                        'card'
                      )
                    ) {
                      ...
                      realTarget = (target.parentElement as Element)
                        .parentElement;
                    }
                    realTarget?.classList.toggle('is-flipped');
                  }}
                >
                  <div
                    className={`card__face card__face--front ${divStyle} py-4 px-3 bg-neutral-200 mb-2 rounded w-full h-full flex flex-col justify-center align-middle`}
                    key={word.id}
                  >
                    {/* <div> */}
