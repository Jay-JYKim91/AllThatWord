...
const Admin: React.FC<Props> = ({ words, setWords, folders, setFolders }) => {
  ...
  console.log(`selectedFolder: ${folders[selectedFolderId]}`);
  let selectedFolderObj = folders[selectedFolderId]
    ? (folders[selectedFolderId] as Folder)
    : {};
  console.log(selectedFolderObj);
  const [editedFolderName, setEditedFolderName] = useState(
    selectedFolderObj ? selectedFolderObj.name : ''
  );
  ...
  useEffect(() => {
    ...
    console.log(folders);
    setSelectedFolderId(folders ? Object.keys(folders)[0] : '');
  }, [folders]);
  ...
  useEffect(() => {
    selectedFolderObj = folders[selectedFolderId] as Folder;
