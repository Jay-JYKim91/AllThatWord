    ...
    <div className="px-6 md:px-9 lg:px-12 py-4 md:py-6 lg:py-8">
      <div className="flex justify-end max-w-2xl m-auto">
        <button
          ...
          className="flex items-center bg-primary-900 border-2 border-white text-white px-2 py-1 rounded"
        >
      ...
      <div className="text-right mt-2 mb-4 max-w-2xl m-auto">
        <button
          type="button"
          className="bg-primary-900 text-white py-1 px-2 border-2 border-white"
          onClick={() => {
