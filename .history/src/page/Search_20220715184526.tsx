...
import { removeWord, saveWord } from 'services/repository';
  ...
  return (
    <div className="px-6 md:px-9 lg:px-12 py-4 md:py-6 lg:py-8">
      ...
      <div className="py-4 max-w-2xl m-auto">
        ...
        <p className="text-neutral-500 text-right">{data.license.name}</p>
      </div>
    </div>
  );
};
