...
const Admin: React.FC<Props> = ({ words, setWords, folders, setFolders }) => {
  ...
  const handleEditFolder = () => {
    ...
    const input = document.getElementById('folderEditForm');
  ...
  return (
    <div className="px-6 md:px-9 lg:px-12 py-4 md:py-6 lg:py-8">
      ...
      <div className="my-2 flex justify-between items-center">
        ...
        <button type="button" onClick={submitEditFolder} id="submitBtn">
          <AiOutlineCheck className="text-2xl text-primary-900 hidden" />
        </button>
      </div>
