  ...
  return (
    <div className="px-6 md:px-9 lg:px-12 py-4 md:py-6 lg:py-8">
      ...
      <div>
        ...
        {viewMode === 'flashcard' && (
          <div className="h-[30vh] overflow-hidden relative my-10">
            <button
              type="button"
            ...
            {Object.keys(words).map((key, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="card__face card__face--back flex flex-col justify-center align-middle overflow-y-scroll">
                    {word.meanings.map((meaning) => {
                      return (
                        <div key={meaning.partOfSpeech}>
