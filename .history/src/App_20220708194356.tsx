      ...
      <header className="px-6 md:px-9 lg:px-12 py-4 shadow-md bg-primary-900">
        <div className="flex justify-between max-w-7xl m-auto">
          ...
          <button
            ...
            className="flex self-center border-2 border-primary-900 p-2 bg-white text-primary-900 rounded hover:bg-primary-900  hover:border-white hover:text-white transition hover:ease-linear"
          >
