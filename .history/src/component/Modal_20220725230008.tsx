...
import { Data, Phonetic } from 'page/Search';
...
const Modal: React.FC<Props> = ({ folders, setFolders, word }) => {
  ...
  return (
    <div
      className="bg-white border border-primary-900 hidden absolute right-0 pt-4 min-w-[230px]"
      id="modal"
    >
      ...
      <button
        id="displayFormBtn"
        type="button"
        className="flex text-neutral-600 items-center px-4"
