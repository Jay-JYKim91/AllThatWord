...
import { WordInAllWords, WordProp } from 'page/Search';
...
const Word: React.FC<Prop> = ({ word, setWords, words, setFolders }) => {
  ...
  const handleDelete = (id: string) => {
    ...
    setFolders((folders) => {
      ...
      const wordInAllWords: WordInAllWords = words[id] as WordInAllWords; // {folderId: folderId}
      const t2 = updated[wordInAllWords.folderId]['words'];
      console.log(updated[wordInAllWords.folderId]);
      delete t2[`${word.id}`];
      return updated;
    });
