...
export function saveWordToUser(userId: string, word: string, folderId: string) {
  set(ref(db, `${userId}/allWords/${word}`), folderId);
}
...
export function removeWord(userId: string, wordId: string, folderId: string) {
